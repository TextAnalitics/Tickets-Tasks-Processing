...
def word_count(stopword):
   ...
   path='C:/Users/ninar/OneDrive/Documents/Research/Telekom/DML_new/Adjectives'
  ...
  #________________________________________________________
   ...
   #print(BSC_Adj)
   #________________________________________________________ 
   path='C:/Users/ninar/OneDrive/Documents/Research/Telekom/DML_new/Adverbs'
  ...
  #________________________________________________________
   ...
   path='C:/Users/ninar/OneDrive/Documents/Research/Telekom/DML_new/Nouns'
  ...
  #________________________________________________________
   ...
   #_________________________________________________________
   path='C:/Users/ninar/OneDrive/Documents/Research/Telekom/DML_new/Verbs'
  ...
  #________________________________________________________
   ...
   k=0
   fb=open('C:/Users/ninar/OneDrive/Documents/RESEARCH/Telekom/2_Research_Tasks/DML_Statistics.doc', 'wb')
         ...
         for line in file_object:
            ...
            if enc==0:
               ...
               if len(line.strip())!=0:
                  ...
                  print(str(kkk)+'.'+str(yy[0])+'.'+str(oo1)+'.'+str(yy[1])+'.'+str(oo2)+'.'+str(yy[2])+'.'+str(oo3)+'.'+str(yy[3])+'.'+str(oo4)+','+str(yy[4])+','+str(oo5)+','+str(yy[5])+','+str(oo6)+','+str(yy[6])+','+str(oo7)+','+str(yy[7])+','+str(oo8)+'.'+str(yy[8])+'.'+str(oo9)+'.'+str(yy[9])+'.'+str(oo10)+','+str(yy[10])+'.'+str(oo11)+'.'+str(yy[11])+'.'+str(oo12))
